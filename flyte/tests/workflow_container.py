"""
Source: https://github.com/flyteorg/flytesnacks/blob/master/examples/customizing_dependencies/customizing_dependencies/raw_container.py
Documentation: https://docs.flyte.org/en/latest/user_guide/customizing_dependencies/raw_containers.html
"""
